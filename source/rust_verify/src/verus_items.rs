...
fn verus_items_map() -> Vec<(&'static str, VerusItem)> {
    vec![
        ...
        ("verus::builtin::guard_ensures",          VerusItem::Spec(SpecItem::GuardEnsures)),
        ("verus::builtin::guard_effects",          VerusItem::Spec(SpecItem::GuardEffects)),
        ...
        ("verus::builtin::get_imaginary_field",       VerusItem::Expr(ExprItem::GetImaginaryField)),
        ...
        ("verus::vstd::guards::guards",  VerusItem::Vstd(VstdItem::Guards, Some(Arc::new("guards::guards".to_owned())))),
