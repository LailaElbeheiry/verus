...
use syn_verus::{
    ...
    TraitItemFn, Type, TypeFnProof, TypeFnSpec, TypePath, UnOp, Visibility, braced, bracketed,
...
impl Visitor {
    ...
    fn take_sig_specs<TType: ToTokens>(
        ...
        let guard_effects = self.take_ghost(&mut spec.guard_effects);
